...
import com.example.tharani.imdbproject.json.JSONdata;
...
public class MovieDetailActivity extends AppCompatActivity implements View.OnClickListener
{
    TextView textView_title, textView_description, textView_date, textView_budget,
            ...
            textView_overview, textView_favorites, textView_watchlist,
            textView_posters, textView_trailers,
            textView_cast, textView_crew;
    ...
    MovieInfo imdb = new MovieInfo();
    MovieDbHelper movieDbHelper = new MovieDbHelper(MovieDetailActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_favorites = (TextView) findViewById(R.id.textView_favorites);
        textView_watchlist = (TextView) findViewById(R.id.textView_watchlist);
        textView_posters   = (TextView) findViewById(R.id.textView_posters);
        textView_trailers = (TextView) findViewById(R.id.textView_trailers);
        textView_cast = (TextView) findViewById(R.id.textView_cast);
        textView_crew = (TextView) findViewById(R.id.textView_crew);
        ...
        Log.e("id string", id);
        imdb = movieDbHelper.getEntry(parseInt(id));
        if (imdb != null) {
            Log.e("ID", String.valueOf(imdb.getMovie_id()));
            Log.e("is_favorite", String.valueOf(imdb.getFavorite()));
            Log.e("is_watchlist", String.valueOf(imdb.getWatchlist()));
        }
    ...
    public void onClick(View v)
    {
        ...
        {
            imdb = movieDbHelper.getEntry(parseInt(id));
            if (movieDbHelper.MovieIDExist(parseInt(id)))
            {
                if (imdb.getFavorite() == 0)
                {
                    Log.e("fav added id", id);
                    movieDbHelper.UpdateFavorite(parseInt(id), 1);

                    imageView_favorites.setImageResource(R.drawable.clicked_favourite);
                }
                else if (imdb.getFavorite() == 1)
                {
                    movieDbHelper.UpdateFavorite(parseInt(id), 0);
                    imageView_favorites.setImageResource(R.drawable.unclicked_favourite);
                }
            }
            else
            {
                movieDbHelper.InsertNewEntry(parseInt(id), 1, 0);
                imageView_favorites.setImageResource(R.drawable.clicked_favourite);
            }
        }
        else if (v.getId() == R.id.imageView_watchlist)
        {
            ...
            if (movieDbHelper.MovieIDExist(parseInt(id)))
            {
                if (imdb.getWatchlist() == 0)
                {
                    movieDbHelper.UpdateWatchlist(parseInt(id), 1);
                    imageView_watchlist.setImageResource(R.drawable.clicked_watchlist);
                }
                else if (imdb.getWatchlist() == 1)
                {
                    movieDbHelper.UpdateWatchlist(parseInt(id), 0);
                    imageView_watchlist.setImageResource(R.drawable.unclicked_watchlist);
                }
            }
            else
            {
                movieDbHelper.InsertNewEntry(parseInt(id), 0, 1);
                imageView_watchlist.setImageResource(R.drawable.clicked_watchlist);
            }
    ...
    class JSON_movieDetails extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (imdb != null) {
                if (imdb.getFavorite() == 1) {
                    imageView_favorites.setImageResource(R.drawable.clicked_favourite);
                } else if (imdb.getFavorite() == 0) {
                    imageView_favorites.setImageResource(R.drawable.unclicked_favourite);
                }

                if (imdb.getWatchlist() == 1) {
                    imageView_watchlist.setImageResource(R.drawable.clicked_watchlist);
                } else if (imdb.getWatchlist() == 0) {
                    imageView_watchlist.setImageResource(R.drawable.unclicked_watchlist);
                }
            }
            else
